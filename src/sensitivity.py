...
def _best_for_pop(evals: list, pop_size: int,
    ...
    # Unique-but-reproducible seed per parameter combination
    # so different pop sizes actually produce different samples.
    random.seed(hash((42, alpha, beta, pop_size)) % (2**31))
